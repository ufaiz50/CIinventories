    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            var myPieChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: [<?php foreach($dtbarang as $dba){echo '"' . $dba['nama_barang'] . '",';} ?>],
                    datasets: [{
                        data: [<?php foreach($barang_sisa as $bs){echo '"' . $bs['stok'] . '",';}?>],
                        backgroundColor: ['#4e73df', '#e74a3b', '#27dcff', '#d94d7f', '#a2d551'],
        ...
        var myBarChart = new Chart(ctx, {
                ...
                data: {
                    labels: [<?php foreach($dtbarang as $dba){echo '"' . $dba['nama_barang'] . '",';} ?>],
                    datasets: [{
                        data: [<?php foreach($trend as $tre){echo '"' . $tre['jumlah_keluar'] . '",';}?>],
                        backgroundColor: ['#4e73df', '#e74a3b', '#FFFF00', '#800080','#8B4513'],
